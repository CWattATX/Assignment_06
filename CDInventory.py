...
# CWatt, 2022-Nov-20, Created File
#------------------------------------#
...
class DataProcessor:
    ...
    def del_inventory(intIDDel):
        ...
        id_num : ID of row to be deleted
...
class FileProcessor:
    ...
    def write_file(file_name, table):
          """Function to manage writing from list to file.
          Writes the data to file identified by file_name in csv format
          writes from dictionary to csv format
          
       Args
           file_name: name of file to read the data 
...
class IO:
    ...
    def add_inventory_menu():
        """User inputto add  CD to the inventory
        Args:
            None.
        Returns:
            strID: the ID of CD
